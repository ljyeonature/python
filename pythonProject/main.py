...
for n in range(len(names)):
    try:
        ...
        try:
            ...
            entryFrame = driver.find_element_by_css_selector("iframe#entryIframe")
            driver.switch_to.frame(entryFrame)
            time.sleep(5)
            # driver.switch_to.frame(frame(driver.find_element_by_css_selector("iframe#entryIframe")));
